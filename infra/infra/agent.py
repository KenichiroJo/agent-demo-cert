...
# === 小売EC需要予測エージェント ランタイムパラメータ ===
_retail_agent_params = {
    "PROMPT_TEMPLATE_ID": ("string", ""),
    "COMPANY_NAME": ("string", "小売EC需要予測デモ"),
    "FORECAST_DEPLOYMENT_ID": ("string", ""),
    "SCORING_DATASET_ID": ("string", ""),
    "VDB_DEPLOYMENT_ID": ("string", ""),
}
for _key, (_type, _default) in _retail_agent_params.items():
